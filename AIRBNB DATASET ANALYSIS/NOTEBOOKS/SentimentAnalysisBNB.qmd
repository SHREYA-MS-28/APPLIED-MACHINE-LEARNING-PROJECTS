...
```{r}
june25_reviews   <- read.csv("june25_reviews.csv")
may25_reviews    <- read.csv("may25_reviews.csv")
april25_reviews  <- read.csv("april25_reviews.csv")
march25_reviews  <- read.csv("march25_reviews.csv")
feb25_reviews    <- read.csv("feb25_reviews.csv")
jan25_reviews    <- read.csv("jan25_reviews.csv")
dec24_reviews    <- read.csv("dec24_reviews.csv")
nov24_reviews    <- read.csv("nov24_reviews.csv")
oct24_reviews    <- read.csv("oct24_reviews.csv")
sept24_reviews   <- read.csv("sept24_reviews.csv")
august24_reviews <- read.csv("august24_reviews.csv")
july24_reviews   <- read.csv("july24_reviews.csv")
